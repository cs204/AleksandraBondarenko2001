...
//Эквивалентность, сказал правду - значит рыцарь
знания1.добавить(new Эквивалентность(new И(БЛжец, БРыцарь, ), БЛжец))
...
//Эквивалентность, сказал правду - значит рыцарь
знания2.добавить(new Эквивалентность(new И(БЛжец, БРыцарь, ), БЛжец))
...
//Эквивалентность, сказал правду - значит рыцарь
знания3.добавить(new Эквивалентность(new И(АЛжец, АРыцарь, ), АЛжец))
// знания3 = new И()
//Эквивалентность, рыцарь - не лжец
...
//Эквивалентность, сказал правду - значит рыцарь
знания3.добавить(new Эквивалентность(new И(ВЛжец, ВРыцарь, ), ВЛжец))
